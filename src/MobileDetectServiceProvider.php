...
use Riverskies\Laravel\MobileDetect\Directives\HandheldIncludingIosBladeDirective;
...
class MobileDetectServiceProvider extends ServiceProvider
{
    ...
    private function registerBladeDirectives(MobileDetect $mobileDetect)
    {
        ...
        $this->registerDirective(new HandheldIncludingIosBladeDirective($mobileDetect));
    }
